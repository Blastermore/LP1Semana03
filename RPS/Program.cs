...
namespace RPS
{
    class Program
    {
        private static void Main(string[] args)
        {
            ...
            GameItem myItem1 = (GameItem)Enum.Parse(typeof(GameItem),args[0]);
            GameItem myItem2 = (GameItem)Enum.Parse(typeof(GameItem),args[1]);


            GameStatus result = RockPaperScissors (myItem1, myItem2);
            switch (result)
            {
